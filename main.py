...
class Server:
    def __init__(self, host = 'localhost', port = 8080,img_folder_name = 'img'):
    ...
    def handle_api_images(self, client_socket):
        ...
        try:
            img_dir = os.path.join(self._current_dir, 'img')
            images = []
        ...
        try:
            ...
            if method == 'GET':
                ...
                if path == '/api/images':
                    ...
                    return
                if path == '/':
                    path = 'src/pages/main.html'
                elif path == '/panorams':
                    path = 'src/pages/panorams.html'
                elif path == '/games':
                    path = 'src/pages/gameMenu.html'
                elif path == '/documentation':
                    path = 'src/pages/documentation.html'
                elif path == '/games/guesspanoram':
                    path == '/guessPanorams.html'


                file_path = self._current_dir + path
                if os.path.exists(file_path) and os.path.isfile(file_path):
                    ...
                    with open('src/errors/404.html', 'rb') as file:
                        content = file.read()
                    response = (
                ...
                with open('src/errors/405.html', 'rb') as file:
                    content = file.read()
                response = (
            ...
            with open('src/errors/500.html', 'rb') as file:
                content = file.read()
    ...
    def start(self):
        ...
        try:
            ...
            print(f'сервер запущен http://{self._host}:{self._port}')
